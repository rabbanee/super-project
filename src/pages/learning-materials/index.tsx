...
const LearningMaterials = ({ user }: LearningMaterialsProps) => {
  ...
  return (
    <>
      <Modal isShow={isConfirmationModalShow} setIsShow={setIsConfirmationModalShow}>
        ...
        <ModalFooter className="sm:px-6">
          ...
          <Button.Secondary type="button" className="mt-3 w-full inline-flex justify-center shadow-sm text-base font-medium sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" onClick={() => setIsConfirmationModalShow(false)}>
            Batal
          </Button.Secondary>
        </ModalFooter>
      </Modal>
      <LayoutWithSidebar title="Materi Pembelajaran" user={user}>
        <Container>
          <BodyContainer className="rounded-b-xl space-y-2">
