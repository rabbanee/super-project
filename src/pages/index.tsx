    ...
    <LayoutWithSidebar title="Beranda" user={user}>
      ...
      <div className="bg-white p-6 md:px-7 rounded-xl shadow-md relative overflow-hidden container mx-auto mt-5">
        ...
        <div className="flex w-full bg-white lg:space-x-4 flex-col space-y-5 lg:space-y-0 lg:flex-row">
          <div className="bg-white shadow-lg w-full lg:w-72">
            ...
            <div className="p-4">
              ...
              <button className="px-3 py-1 bg-primary-light text-gray-50 rounded-md mt-3 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-white focus:ring-offset-2">Baca lebih banyak</button>
            </div>
          </div>
          <div className="bg-white shadow-lg w-full lg:w-72">
            <div className="bg-red-200 h-44 w-full">
