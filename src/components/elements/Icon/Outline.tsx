...
export const MenuAlt1 = (props: IconProps) => {
  return (
    <svg className={`${props.className && props.className}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const Selector  = (props: IconProps) => {
  return (
    <svg className={`${props.className && props.className}`} viewBox="0 0 20 20" fill="none" stroke="currentColor">
...
export const Circle = (props: IconProps) => {
  return (
    <svg className={`${props.className && props.className}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
export const Collection = (props: IconProps) => {
  return (
    <svg className={`${props.className && props.className}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const Adjustments = (props: IconProps) => {
  return (
    <svg className={`${props.className && props.className}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
