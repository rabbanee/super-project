  ...
  return (
    <div className="bg-gray-200 dark:bg-gray-800">
      <div className="min-w-screen container mx-auto min-h-screen md:flex md:px-7 md:space-x-1 max-w-8xl">
        <Sidebar.Mobile user={props.user} permissions={props.permissions} />
        <Sidebar.Desktop user={props.user} permissions={props.permissions}  className="md:mt-9 bg-white md:rounded-xl md:w-2/6 lg:w-1/5 hidden md:block max-w-xs"/>
        <Layout
          title={props.title} 
